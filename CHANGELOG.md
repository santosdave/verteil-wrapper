...
- Introduced new methods in RequestHelper for handling complex parameter transformations
- Added support for nested parameter structures in RequestHelper
- Implemented validation logic for transformed parameters in RequestHelper

### Changed

- Refactored existing methods in RequestHelper for better performance and readability
- Updated RequestHelper to handle additional edge cases in parameter transformations

### Fixed

- Fixed issues with incorrect parameter mapping in RequestHelper
- Corrected bugs related to parameter validation in RequestHelper
- Resolved inconsistencies in transformed parameter structures
